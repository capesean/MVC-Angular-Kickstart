...
(function () {
    ...
    function clientResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "clients/:clientId",
            { clientId: "@clientId" },
            {
                list: {
                    method: "GET",
    ...
    function clientTypeResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "clienttypes/:clientTypeId",
    ...
    function disbursementResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "disbursements/:disbursementId",
    ...
    function disbursementBatchResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "disbursementbatches/:disbursementBatchId",
    ...
    function disbursementBudgetResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "disbursementbudgets/:disbursementBudgetId",
            { disbursementBudgetId: "@disbursementBudgetId" }
        );
    }
    //#endregion
    ...
    function expenditureTypeResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "expendituretypes/:expenditureTypeId",
    ...
    function invoiceResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "invoices/:invoiceId",
            { invoiceId: "@invoiceId" },
            {
                detachTimes: {
                    method: "POST",
    ...
    function milestoneResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "milestones/:milestoneId",
    ...
    function milestoneSummariesResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "milestonesummaries/:milestoneId",
            { milestoneId: "@milestoneId" },
            {
                timeByMonth: {
                    method: "GET",
    ...
    function pastelAccountResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "pastelaccounts/:pastelAccountId",
            { pastelAccountId: "@pastelAccountId" }
        );
    }
    //#endregion
    ...
    function pastelCreditorResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "pastelcreditors/:pastelCreditorId",
            { pastelCreditorId: "@pastelCreditorId" }
        );
    }
    //#endregion
    ...
    function practiceAreaResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "practiceareas/:practiceAreaId",
    ...
    function projectTypeResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "projecttypes/:projectTypeId",
    ...
    function rateResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "rates/:rateId",
            { rateId: "@rateId" },
            {
                getApplicableRate: {
                    method: "GET",
    ...
    function timeResource($resource, appSettings) {
        return $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "times/:timeId",
            { timeId: "@timeId" }
        );
    }
    //#endregion
    ...
    function api($resource, appSettings) {
        ...
        var projectSummary = $resource(appSettings.apiServiceBaseUri + appSettings.apiPrefix + "projects/:projectId/summary",
            { projectId: "@projectId" });
